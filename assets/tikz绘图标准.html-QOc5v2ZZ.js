import{_ as l,c as p,b as e,d as i,a,e as t,r,o as d}from"./app-D1zV2Gjb.js";const h={};function o(c,s){const n=r("Tikz");return d(),p("div",null,[s[0]||(s[0]=e(`<h1 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h1><h2 id="环境配置" tabindex="-1"><a class="header-anchor" href="#环境配置"><span>环境配置</span></a></h2><p>代码类型: tikz</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>\\usepackage{tikz}</span></span>
...
\\end{tikzpicture}
\\end{document}
`}),s[1]||(s[1]=e(`<h3 id="代码优化点" tabindex="-1"><a class="header-anchor" href="#代码优化点"><span>代码优化点：</span></a></h3><ol><li><strong>斜线填充</strong>： <ul><li>不能使用 <code>\\foreach</code> 在 <code>\\clip</code> 内部，因此 <strong>使用 <code>\\clip</code> 限制区域，然后绘制一系列平行线</strong>，保证它们只出现在圆内部。</li><li>这里的 <code>\\foreach \\y in {-1.5,-1.2,...,1.5}</code> 产生 <strong>从左到右的斜线</strong>。</li></ul></li><li><strong>旋转箭头</strong>： <ul><li>直接用 <code>arc[start angle=0,end angle=45]</code> 绘制 <strong>顺时针旋转的小箭头</strong>。</li></ul></li></ol><hr><h2 id="颜色填充" tabindex="-1"><a class="header-anchor" href="#颜色填充"><span>颜色填充</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>% 填充阴影区域</span></span>
<span class="line"><span>\\begin{scope} \\clip (0,-1.5) rectangle (1,0); \\fill[black!20,opacity=0.7] plot[domain=0.01:1,smooth]({\\x}, {ln(\\x)}) -- (1,0) -- (0,0) -- cycle; \\end{scope}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div>`,5)),i(n,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
...
\\end{tikzpicture}
\\end{document}
`}),s[2]||(s[2]=e(`<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>% 内层</span></span>
...
<span class="line"><span> -- cycle;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="标准绘图原则" tabindex="-1"><a class="header-anchor" href="#标准绘图原则"><span><strong>标准绘图原则</strong></span></a></h2><p>✅ <strong>2D：确保 <code>y</code> 轴范围受控，避免 TikzJax 计算溢出</strong><br> ✅ <strong>3D：固定 <code>\\tdplotsetmaincoords{80}{120}</code>，只绘制关键轮廓</strong><br> ✅ <strong>曲线：使用 <code>smooth</code> 和 <code>samples=100</code>，提高解析精度</strong><br> ✅ <strong>颜色：仅用黑白，避免 <code>colormap</code> 和 <code>fill opacity</code></strong><br> ✅ <strong>阴影：尽量 <code>filldraw</code> 而非 <code>clip</code>，减少 TikzJax 解析负担</strong></p><hr><h2 id="polygon" tabindex="-1"><a class="header-anchor" href="#polygon"><span>Polygon</span></a></h2><p>You can use the geometric shapes given by the shapes.geometric library</p><div class="language-latex line-numbers-mode" data-highlighter="shiki" data-ext="latex" data-title="latex" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">\\usetikzlibrary</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">{shapes.geometric}</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">\\end</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">{</span><span style="--shiki-light:#383A42;--shiki-light-font-style:inherit;--shiki-dark:#E06C75;--shiki-dark-font-style:italic;">document</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Upgrade:</strong> An improved version, which itself calculate all necessary data from given number of nodes and angle of the first node position:</p><div class="language-latex line-numbers-mode" data-highlighter="shiki" data-ext="latex" data-title="latex" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">\\documentclass</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">[</span><span style="--shiki-light:#383A42;--shiki-light-font-style:inherit;--shiki-dark:#E06C75;--shiki-dark-font-style:italic;">border=3mm,tikz</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">]{</span><span style="--shiki-light:#C18401;--shiki-dark:#E5C07B;">standalone</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">\\begin</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">{</span><span style="--shiki-light:#383A42;--shiki-light-font-style:inherit;--shiki-dark:#E06C75;--shiki-dark-font-style:italic;">document</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span>
...
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">\\end</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">{</span><span style="--shiki-light:#383A42;--shiki-light-font-style:inherit;--shiki-dark:#E06C75;--shiki-dark-font-style:italic;">document</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h1 id="案例" tabindex="-1"><a class="header-anchor" href="#案例"><span>案例</span></a></h1><h2 id="_2d" tabindex="-1"><a class="header-anchor" href="#_2d"><span>2D</span></a></h2>`,19)),i(n,{data:`\\begin{document}
\\begin{tikzpicture}
% 绘制坐标轴
...
\\end{tikzpicture}
\\end{document}
`}),s[3]||(s[3]=a("h2",{id:"_3d",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#_3d"},[a("span",null,"3D")])],-1)),s[4]||(s[4]=a("p",null,[a("strong",null,[t("必须需要导入 "),a("code",null,"\\usepackage{tikz-3dplot}"),t(" 包!")])],-1)),i(n,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
...
\\end{tikzpicture}
\\end{document}
`}),s[5]||(s[5]=a("p",null,"真实边缘轮廓的角度为 \\tdplotsetmaincoords{80}{120} 后者120和其补角: 120+180, 这两个线是真实视角边缘轮廓线",-1)),i(n,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
   % 设置 3D 视角
...
\\end{tikzpicture}
\\end{document}
`}),s[8]||(s[8]=a("h3",{id:"标准旋转体填充",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#标准旋转体填充"},[a("span",null,"标准旋转体填充")])],-1)),s[9]||(s[9]=a("p",null,"以后旋转体都严格按照这个模式进行",-1)),i(n,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
...
\\end{tikzpicture}
\\end{document}
`}),s[10]||(s[10]=a("h2",{id:"树状图",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#树状图"},[a("span",null,"树状图")])],-1)),s[11]||(s[11]=a("h3",{id:"纵向",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#纵向"},[a("span",null,"纵向")])],-1)),i(n,{data:`\\begin{document}
\\begin{tikzpicture}
    % 根节点
    \\node {$z$}
        child {node {$x$} 
...
\\end{tikzpicture}
\\end{document}
`}),s[12]||(s[12]=a("h3",{id:"横向",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#横向"},[a("span",null,"横向")])],-1)),i(n,{data:`\\begin{document}
\\begin{tikzpicture}[
    grow=right, % 让树从左向右生长
...
\\end{tikzpicture}
\\end{document}
`}),s[14]||(s[14]=a("hr",null,null,-1)),s[15]||(s[15]=a("h2",{id:"其他案例",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#其他案例"},[a("span",null,"其他案例")])],-1)),s[16]||(s[16]=a("p",null,[t("一个失败的案例, 原因是忘记导入 "),a("code",null,"\\usepackage{tikz-3dplot}"),t(" 包了, 加上就好")],-1)),i(n,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
    % 设置 3D 视角
    \\tdplotsetmaincoords{70}{120}
...
\\end{tikzpicture}
\\end{document}
`}),s[17]||(s[17]=a("h2",{id:"automaton",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#automaton"},[a("span",null,"Automaton")])],-1)),s[18]||(s[18]=a("h3",{id:"tikz绘制自动机的状态转移图示例",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#tikz绘制自动机的状态转移图示例"},[a("span",null,"tikz绘制自动机的状态转移图示例:")])],-1)),i(n,{data:`\\usepackage{tikz}
...
\\end{tikzpicture}
\\end{document}
`}),s[19]||(s[19]=a("h3",{id:"多边形",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#多边形"},[a("span",null,"多边形")])],-1)),i(n,{data:`\\usepackage{tikz}
...
`}),s[20]||(s[20]=a("h3",{id:"example",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#example"},[a("span",null,"example")])],-1)),i(n,{data:`\\usepackage{tikz}
